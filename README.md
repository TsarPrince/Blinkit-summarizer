...
3. Replace curl.sh (the script extracts the required headers and cookies from this while preventing [TLS Fingerprinting](https://www.youtube.com/watch?v=ISr2ETG4E4M) (Blinkit blocks direct curls via Cloudflare)
